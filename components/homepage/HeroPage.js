      ...
      <div className="relative w-full flex z-10 md:px-2 md:py-2">
        <div className='w-full md:w-[60%]'>
          <div className='w-full  p-6 bg-gray-300 md:rounded-l-3xl  h-[70vh] relative'>
            ...
            <div className="text-sm z-20 flex border border-black drop-shadow-2xl items-center gap-2 py-1 px-1 rounded-2xl bg-gray-400 w-fit mb-4 relative">
              <span className="py-1 px-2 rounded-2xl bg-gray-300 text-black font-medium">
                2000+ IIT Questions
              </span>
              <span className="flex items-center gap-2 h-full text-white">
            ...
            <div className="flex gap-4 mt-3 md:mt-0 z-20 flex-wrap">
              ...
              <button className="relative overflow-hidden w-full md:w-fit  bg-primary text-black px-6 py-3 rounded-full font-semibold transition-all duration-500 group cursor-pointer">
